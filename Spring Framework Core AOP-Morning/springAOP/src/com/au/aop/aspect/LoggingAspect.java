...
//	}
	...
	@After("allGetters()")
	public void AfterSecondAdvice() {
		System.out.println("After Second Advice");
		
	}
	@AfterReturning("allGetters()")
	public void AfterReturningSecondAdvice() {
		System.out.println("AfterReturning Second Advice");
		
	}
	@AfterThrowing("allGetters()")
	public void AfterThrowingSecondAdvice() {
		System.out.println("AfterThrowing Second Advice");
